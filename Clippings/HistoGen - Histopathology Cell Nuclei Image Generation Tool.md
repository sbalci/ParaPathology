...
HistoGen adopts the spatial formulation established by Graham et al. in [HoVer-NeXt](../computational-digital-and-mathematical-pathology/hover-next.md) / HoVer-Net:
...
- **Primary Disciplines:** [Digital Pathology](../computational-digital-and-mathematical-pathology/digital-pathology.md), [Image Analysis](../computational-digital-and-mathematical-pathology/image-analysis.md), [Digital Pathology Software](../computational-digital-and-mathematical-pathology/digital-pathology-software.md), What AI Can and Cannot Do in Pathology
- **Nuclear Segmentation Models:** [HoVer-NeXt](../computational-digital-and-mathematical-pathology/hover-next.md)
- **Foundation Models & Benchmarking:** [Towards robust foundation models for digital pathology](Towards%20robust%20foundation%20models%20for%20digital%20pathology.md), [Navigating foundation model selection in digital pathology through performance evaluation and tradeoff analysis](Navigating%20foundation%20model%20selection%20in%20digital%20pathology%20through%20performance%20evaluation%20and%20tradeoff%20analysis.md)
- **Governance & Regulatory Standards:** [Ethical guidelines for deploying artificial intelligence applications in the pathology field: Lessons learned from a prospective framework in a large tertiary care academic medical center](Ethical%20guidelines%20for%20deploying%20artificial%20intelligence%20applications%20in%20the%20pathology%20field%20-%20Lessons%20learned%20from%20a%20prospective%20framework%20in%20a%20large%20tertiary%20care%20academic%20medical%20center.md), [Considerations for digital pathology displays](Considerations%20for%20digital%20pathology%20displays.md)
