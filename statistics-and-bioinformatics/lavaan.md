...
- Time-to-event with one outcome → Cox model. (See [Kaplan Meier](kaplan-meier.md) and [competing-risk regression](../Clippings/Regression%20modeling%20of%20competing%20risk%20using%20R%20an%20in%20depth%20guide%20for%20clinicians%20-%20Bone%20Marrow%20Transplantation.md).)
