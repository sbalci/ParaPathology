...
- **Complement to Patch-Level Models:** While [WSInfer](wsinfer.md) provides patch-level classification overlays, HoVer-NeXt operates at single-cell resolution, making it suitable for single-cell morphometry, density gradients, and tumor-stroma architectural boundaries.
- **Robustness Profiling:** Encoders and feature representations can be evaluated against center and scanner domain shifts using metrics from [CRoMa](croma.md) (Grisi et al., 2026).
