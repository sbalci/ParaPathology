...
#### OpenFlexure: Robotic microscopy for everyone

Reviewed in [[Robotic microscopy for everyone: the OpenFlexure Microscope]] and [OpenFlexure Microscope](openflexure-microscope.md) — foundational open-hardware and robotic digital microscopy framework developed by Dr. Richard Bowman, Julian Stirling, and colleagues across the University of Bath and Cambridge. Replaces precision-machined sliding translation stages with a monolithic 3D-printed flexure stage capable of sub-100 nm positioning resolution. Integrates modular RMS DIN finite/infinity optics, Sangaboard motor control, a Python REST API / WebSocket daemon (`openflexure-microscope-server`), automated 2D tiled whole-slide scanning, and live streaming for telepathology. Validated in field trials for automated malaria screening in Tanzania, decentralized whole-slide imaging (WSI), and remote telepathology consultations (Collins et al., *Biomedical Optics Express* 2020, DOI: 10.1364/BOE.385729; Sharkey et al., *Review of Scientific Instruments* 2016, DOI: 10.1063/1.4941068). Repositories at [openflexure/openflexure-microscope](https://gitlab.com/openflexure/openflexure-microscope) and [rwb27/openflexure_microscope](https://github.com/rwb27/openflexure_microscope).
